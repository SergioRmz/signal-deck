...
```json
{
  "meta": {
    ...
    "readerContext": {
      ...
      "desiredUpgrade": "Understand where leverage moves when capabilities commoditize."
    }
  },
  "hero": {
    "title": "Workflow ownership is becoming the real AI moat.",
    "lede": "A compact strategic read on how value capture is moving up the stack.",
    "signal": "Capability is diffusing faster than workflow ownership.",
    "thesis": "Margin is migrating toward whoever owns recurring workflow and context."
  },
  "topLine": {
    ...
    "stakes": "This changes how to evaluate products and moats."
  },
  "radar": {
    ...
    "items": [
      {
        ...
        "mechanism": "Bundling",
        "implication": "Products need workflow depth, not only model access."
      }
    ]
  },
  "marketMap": {
    ...
    "items": [
      {
        ...
        "powerShift": "Leverage compounds where workflow accumulates."
      }
    ]
  },
  "readerTranslation": {
    ...
    "items": [
      {
        ...
        "headline": "Build where context compounds",
        "body": "Skills tied to orchestration and workflow embedding gain leverage."
      }
    ]
  },
  "reusableLesson": {
    "title": "Reusable lesson",
    "pattern": "When a base capability commoditizes, value often migrates upward into workflow ownership.",
    "takeaway": "Check where repetition, context, and switching cost accumulate."
  },
  "watchlist": {
